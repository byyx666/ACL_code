...
class iImageNetR(iData):
    ...
    def download_data(self):
        assert 0, "You should specify the folder of your dataset"
        train_dir = "/data/dataset/Imagenet-R/train/"
        test_dir = "/data/dataset/Imagenet-R/test/"
...
class iImageNetA(iData):
    ...
    def download_data(self):
        assert 0, "You should specify the folder of your dataset"
        train_dir = "/data/dataset/Imagenet-A/train/"
        test_dir = "/data/dataset/Imagenet-A/test/"
