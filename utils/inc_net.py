...
from backbone.linears import SimpleLinear, SplitCosineLinear, CosineLinear, EaseCosineLinear, SimpleContinualLinear, ContinualLinear_ssiat
...
def get_backbone(args, pretrained=False):
    ...
    # VPT
        ...
        if args["model_name"] == "aper_adapter" or args["model_name"] == "ranpac" or args["model_name"] == "fecam" or args["model_name"] == "ssiat":
...
class VitNet_ssiat(BaseNet):
    ...
    def generate_fc(self, in_dim, out_dim):
        fc = ContinualLinear_ssiat(in_dim, out_dim)
        return fc
